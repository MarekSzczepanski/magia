...
const PrivacyPolicy = () => {
  ...
  return (
    <Wrap className={`cookies ${isPrivacyVisible}`}>
      <Span>
        Nasza witryna stosuje pliki cookies. Określenie warunków przechowywania i dostępu do plików
        cookies jest możliwe w przeglądarce.
      </Span>
      <ButtonsParent>
        <StyledLink2>
          <Link className="button button4 privacy-button" to="/polityka-prywatnosci">
            Dowiedz się więcej
          </Link>
        </StyledLink2>
        <Button className="button button4 privacy-button" onClick={acceptPolicy}>
          Akceptuj
        </Button>
      </ButtonsParent>
    </Wrap>
